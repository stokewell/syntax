...
const directions = Object.freeze({
  editorial: direction('editorial', 'Editorial', 'Serif-led, spacious, restrained, and content-first.', {
  ...
  technical: direction('technical', 'Technical', 'Dense, systematic, precise, and documentation-oriented.', {
  ...
  playful: direction('playful', 'Playful', 'Bold, friendly, rounded, and energetic without becoming chaotic.', {
    headingFont: 'var(--font-body)',
    bodyFont: 'var(--font-body)',
    maxWidth: '82rem',
  ...
  cinematic: direction('cinematic', 'Cinematic', 'Large-scale, atmospheric, dramatic, and image-forward.', {
    headingFont: 'var(--font-heading)',
    bodyFont: 'var(--font-body)',
    maxWidth: '92rem',
