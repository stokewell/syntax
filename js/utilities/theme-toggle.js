...
(function (global) {
  ...
  function updateControl(preference) {
    ...
    if (!icon) return;
    const paths = {
      system: '<path d="M4 5h16v11H4zM8 20h8M12 16v4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>',
      light: '<path d="M12 3v2m0 14v2M3 12h2m14 0h2M5.64 5.64l1.42 1.42m9.88 9.88 1.42 1.42m0-12.72-1.42 1.42M7.06 16.94l-1.42 1.42" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="12" r="4" fill="none" stroke="currentColor" stroke-width="2"/>',
  ...
  function applyPreference(preference, options = {}) {
    ...
    document.dispatchEvent(new CustomEvent('syntax-theme-change', {
